...
from suprank.lib.percentage import percentage


def format_for_latex(metrics: Mapping[str, float]) -> str:
    try:
        print_for_latex = []
...
def format_for_latex_dyml(metrics: Mapping[str, float]) -> str:
    try:
        print_for_latex = []
