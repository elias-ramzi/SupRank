from typing import List, Mapping, Any, Callable, Type
import random
...
def get_random_state() -> Mapping[str, np.ndarray]:
...
def set_random_state(RANDOM_STATE: Mapping[str, np.ndarray]) -> NoneType:
